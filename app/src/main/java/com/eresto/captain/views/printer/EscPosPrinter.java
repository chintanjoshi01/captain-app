...
import com.eresto.captain.views.printer.textparser.IPrinterTextParserElement;
import com.eresto.captain.views.printer.textparser.PrinterTextParser;
import com.eresto.captain.views.printer.textparser.PrinterTextParserColumn;
import com.eresto.captain.views.printer.textparser.PrinterTextParserLine;
import com.eresto.captain.views.printer.textparser.PrinterTextParserString;
...
public class EscPosPrinter extends EscPosPrinterSize {
     ...
     * @return Fluent interface
     */
    public EscPosPrinter printFormattedTextAndHalfCut(String text) throws EscPosConnectionException, EscPosParserException, EscPosEncodingException, EscPosBarcodeException {
        return this.printFormattedTextAndHalfCut(text, 20f);
    }
    /**
     * Print a formatted text and cut the paper. Read the README.md for more information about text formatting options.
     *
     ...
     * @return Fluent interface
     */
    public EscPosPrinter printFormattedTextAndHalfCut(String text, float mmFeedPaper) throws EscPosConnectionException, EscPosParserException, EscPosEncodingException, EscPosBarcodeException {
        return this.printFormattedTextAndHalfCut(text, this.mmToPx(mmFeedPaper));
    }
     ...
     * @return Fluent interface
     */
    public EscPosPrinter printFormattedTextAndHalfCut(String text, int dotsFeedPaper) throws EscPosConnectionException, EscPosParserException, EscPosEncodingException, EscPosBarcodeException {
        if (this.printer == null || this.printerNbrCharactersPerLine == 0) {
            return this;
        }

        this.printFormattedText(text, dotsFeedPaper);
        this.printer.halfCutPaper();
