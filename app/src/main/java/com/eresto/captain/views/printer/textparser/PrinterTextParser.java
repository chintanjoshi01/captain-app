...
public class PrinterTextParser {
    ...
    public static final String TEXT_SIZE_1X = "1";
    public static final String TEXT_SIZE_2X = "2";
    public static final String TEXT_SIZE_3X = "3";
    public static final String TEXT_SIZE_4X = "4";
    public static final String TEXT_SIZE_5X = "5";
    public static final String FONT_A = "font_a";
    public static final String FONT_B = "font_b";
    public static final String FONT_C = "font_c";
    ...
    public static final String TAGS_FORMAT_TEXT_TEXT = "text";
    ...
    public static final String ATTR_FORMAT_TEXT_FONT = "text";
    ...
    public PrinterTextParser addTextFont(byte[] newTextSize) {
        this.textFont = PrinterTextParser.arrayBytePush(this.textFont, newTextSize);
        return this;
    }
