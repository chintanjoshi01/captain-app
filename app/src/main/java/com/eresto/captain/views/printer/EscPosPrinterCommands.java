...
import com.eresto.captain.views.printer.barcode.Barcode;
...
//    public static final byte[] TEXT_FONT_A = new byte[]{0x1B,0x21, 0x01};
//    public static final byte[] TEXT_FONT_B = new byte[]{0x1B,0x21, 0x01,0x1B,0x54};
//    public static final byte[] TEXT_FONT_C = new byte[]{0x1B,0x21, 0x01,0x1B,0x55};


    public static final byte[] TEXT_FONT_A = new byte[]{0x1B,0x21, 0x00};
    public static final byte[] TEXT_FONT_B = new byte[]{0x1B,0x21, 0x01};
    public static final byte[] TEXT_FONT_C = new byte[]{0x1B,0x55, 0x01};
//    public static final byte[] TEXT_FONT_D = new byte[]{0x1B, 0x50, 0x03};
//    public static final byte[] TEXT_FONT_E = new byte[]{0x1B, 0x50, 0x04};
// OLD
//    public static final byte[] TEXT_SIZE_1X = new byte[]{0x1D, 0x21, 0x00,0x1D, 0x21, 0x00};
//    public static final byte[] TEXT_SIZE_2X = new byte[]{0x1D, 0x21, 0x01,0x1D, 0x21, 0x10};
//    public static final byte[] TEXT_SIZE_3X = new byte[]{0x1D, 0x21, 0x02,0x1D, 0x21, 0x20};
//    public static final byte[] TEXT_SIZE_4X = new byte[]{0x1D, 0x21, 0x03,0x1D, 0x21, 0x30};
//    public static final byte[] TEXT_SIZE_5X = new byte[]{0x1D, 0x21, 0x04,0x1D, 0x21, 0x40};

    public static final byte[] TEXT_SIZE_1X = new byte[]{0x1D, 0x21, 0x00};
    public static final byte[] TEXT_SIZE_2X = new byte[]{0x1D, 0x21, 0x01};
    public static final byte[] TEXT_SIZE_3X = new byte[]{0x1D, 0x4D, 0x02};
    public static final byte[] TEXT_SIZE_4X = new byte[]{0x1D, 0x4D, 0x03};
    public static final byte[] TEXT_SIZE_5X = new byte[]{0x1D, 0x4D, 0x04};
    ...
    private final EscPosCharsetEncoding charsetEncoding;
    ...
    public EscPosPrinterCommands(DeviceConnection printerConnection, EscPosCharsetEncoding charsetEncoding) {
        ...
        this.charsetEncoding = charsetEncoding != null ? charsetEncoding : new EscPosCharsetEncoding(Utils.printCommand, 6);
    }
...
//      this.printerConnection.write(new byte[]{0x1D, 0x56, 0x01, 0x49});
     ...
     * @return Fluent interface
     */
    public EscPosPrinterCommands halfCutPaper() throws EscPosConnectionException {
        if (!this.printerConnection.isConnected()) {
            return this;
        }
