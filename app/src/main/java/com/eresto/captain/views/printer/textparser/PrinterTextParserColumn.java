...
public class PrinterTextParserColumn {
    ...
    private final PrinterTextParserLine textParserLine;
                    ...
                    if (textParserTag.isCloseTag()) {
                        switch (textParserTag.getTagName()) {
                            ...
                            case PrinterTextParser.TAGS_FORMAT_TEXT_FONT:
                                ...
                                break;
                            case PrinterTextParser.TAGS_FORMAT_TEXT_TEXT:
                        ...
                        switch (textParserTag.getTagName()) {
                            ...
                            case PrinterTextParser.TAGS_FORMAT_TEXT_FONT:
                                if (textParserTag.hasAttribute(PrinterTextParser.ATTR_FORMAT_TEXT_FONT_SIZE)) {
                                    switch (textParserTag.getAttribute(PrinterTextParser.ATTR_FORMAT_TEXT_FONT_SIZE)) {
                                        ...
                                        case PrinterTextParser.ATTR_FORMAT_TEXT_FONT_SIZE_BIG:
                                            ...
                                            break;
                                        case PrinterTextParser.TEXT_SIZE_1X:
                                            textParser.addTextSize(EscPosPrinterCommands.TEXT_SIZE_1X);
                                            break;
                                        case PrinterTextParser.TEXT_SIZE_2X:
                                            textParser.addTextSize(EscPosPrinterCommands.TEXT_SIZE_2X);
                                            break;
                                        case PrinterTextParser.TEXT_SIZE_3X:
                                            textParser.addTextSize(EscPosPrinterCommands.TEXT_SIZE_3X);
                                            break;
                                        case PrinterTextParser.TEXT_SIZE_4X:
                                            textParser.addTextSize(EscPosPrinterCommands.TEXT_SIZE_4X);
                                            break;
                                        case PrinterTextParser.TEXT_SIZE_5X:
                                            textParser.addTextSize(EscPosPrinterCommands.TEXT_SIZE_5X);
                                            break;
                                    }
                                } else {
                                    textParser.addTextSize(EscPosPrinterCommands.TEXT_SIZE_NORMAL);
                                ...
                                if (textParserTag.hasAttribute(PrinterTextParser.ATTR_FORMAT_TEXT_FONT)) {
                                    switch (textParserTag.getAttribute(PrinterTextParser.ATTR_FORMAT_TEXT_FONT)) {
                                        case PrinterTextParser.FONT_A:
                                        default:
                                            textParser.addTextFont(EscPosPrinterCommands.TEXT_FONT_A);
                                            break;
                                        case PrinterTextParser.FONT_B:
                                            textParser.addTextFont(EscPosPrinterCommands.TEXT_FONT_B);
                                            break;
                                        case PrinterTextParser.FONT_C:
